...
ChatBot::ChatBot(const ChatBot &chatbot)
{
    ...
    // Deep copy as _image is owned by ChatBot
...
{
    std::cout << "ChatBot Copy Assignment Operator" << endl;
    if (this != &chatbot)
    {
        // 
        delete _image;
...
{
    std::cout << "ChatBot Move Constructor" << endl;
...
{
    std::cout << "ChatBot Move Assignment Operator" << endl;
    if (this != &chatbot)
    {
        if (_image != nullptr)
        {
